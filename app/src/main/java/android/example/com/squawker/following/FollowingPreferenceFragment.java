...
public class FollowingPreferenceFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(SquawkContract.ASSER_KEY)){
            Log.d(LOG_TAG,"Asser changed"+sharedPreferences.getBoolean(key,FALSE));
        }
        else if (key.equals(SquawkContract.CEZANNE_KEY)) {
            Log.d(LOG_TAG,"Cezanne changed"+sharedPreferences.getBoolean(key,FALSE));
        }
        else if (key.equals(SquawkContract.JLIN_KEY)) {
            Log.d(LOG_TAG,"Jlyn changed"+sharedPreferences.getBoolean(key,FALSE));
        }
        else if (key.equals(SquawkContract.NIKITA_KEY)) {
            Log.d(LOG_TAG,"Nikita changed"+sharedPreferences.getBoolean(key,FALSE));
        }
        else if (key.equals(SquawkContract.LYLA_KEY)) {
            Log.d(LOG_TAG,"Lyla changed"+sharedPreferences.getBoolean(key,FALSE));
        }
    }
}
